      ...
      <div className="max-w-screen-xl w-full grid grid-cols-1 md:grid-cols-10 lg:grid-cols-12">
        ...
        <div className="col-span-2 lg:col-span-3 border-r border-gray-800 p-4 hidden md:flex flex-col justify-between items-start sticky top-0 h-screen">
          <div className="flex flex-col space-y-6 mt-4">
            <div className="flex items-center space-x-4 text-xl font-bold text-white cursor-pointer hover:bg-gray-900 p-2 rounded-full transition-colors duration-200">
              <Home size={28} />
              <span>Home</span>
            </div>
            <div className="flex items-center space-x-4 text-xl text-gray-400 cursor-pointer hover:bg-gray-900 p-2 rounded-full transition-colors duration-200">
              <Bell size={28} />
          ...
          <button className="mt-8 bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-full text-lg w-full text-center transition-colors duration-200">
            Post
          </button>
          <div className="flex items-center justify-between w-full mt-8 p-2 rounded-full hover:bg-gray-900 cursor-pointer transition-colors duration-200">
            <div className="flex items-center">
              <UserIcon size={40} className="rounded-full bg-gray-700 p-2" />
              <div className="ml-3">
